                    ...
                    <frame id="setting" w="*" h="*">
                        <ScrollView>
                            <vertical w="*" >
                                ...
                                <vertical h="2px" w="*" bg="{{DATA_CONTAINER.line_color}}"></vertical>
                                <button textColor="{{DATA_CONTAINER.normal_text_color}}" id="page_lock_setting" style="Widget.AppCompat.Button.Borderless" gravity="left|center_vertical" text="设置页面子密码"></button>
                                <vertical h="2px" w="*" bg="{{DATA_CONTAINER.line_color}}"></vertical>
